module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'nhập',
      explanation:
        'Viết ở đây bản ghi nhớ, khóa riêng, WIF hoặc bất cứ thứ gì quý khách có. Veles Wallet sẽ cố hết sức để đoán đúng định dạng và nhập ví của quý khách',
      imported: 'Đã nhập',
  ...
  send: {
    ...
    details: {
      ...
      address: 'địa chỉ',
      amount_placeholder: 'số tiền gửi ( bằng VLS)',
      fee_placeholder: 'cộng thêm phí giao dịch ( bằng VLS)',
