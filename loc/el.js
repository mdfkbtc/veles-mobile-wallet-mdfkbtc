module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'Εισαγωγή',
      explanation:
        'Γράψε εδώ το μνημονικό (φράση), το ιδιωτικό κλειδί, το WIF, ή ό,τι άλλο έχεις. Το Veles Wallet θα προσπαθήσει να μαντέψει το σωστό format και να εισάγει το πορτοφόλι',
      imported: 'Εισήχθη',
  ...
  send: {
    ...
    details: {
      ...
      address: 'διεύθυνση',
      amount_placeholder: 'ποσό πληρωμής (σε VLS)',
      fee_placeholder: 'συν έξοδα συναλλαγής (σε VLS)',
  ...
  settings: {
    ...
    lightning_settings_explain:
      ...
      ' και βάλτε το URL του εδώ. Αφήστε το κενό για να χρησιμοποιήσετε το LNDHub της Veles Wallet (lndhub.io). Αφού σώσετε τις ρυθμίσεις τυχόν νέα πορτοφόλια που θα δημιουργήσετε θα συνδεθούν στο LNDHub που επιλέξατε.',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'κωδικό σας. Για να προστατέψετε τα χρήματά σας, το Veles Wallet μπορεί να δημιουργήσει ένα εναλλακτικό ' +
      ...
      'βάλει στο Veles Wallet θα δει ένα μόνο ένα ψεύτικο αρχείο που μοιάζει ' +
