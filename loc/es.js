module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'importar',
      explanation:
        'Escriba aquí su clave mnemotécnica, clave privada, WIF o cualquier cosa que tenga. Veles Wallet hará todo lo posible para adivinar el formato correcto e importar su cartera.',
      imported: 'Importado',
  ...
  send: {
    ...
    details: {
      ...
      fee_placeholder: 'más tasa de transaccion (en VLS)',
  ...
  plausibledeniability: {
    ...
    help:
      'En determinadas circunstancias, podría verse obligado a revelar su contraseña. Para mantener sus monedas seguras, Veles Wallet puede crear otro almacenamiento cifrado con una contraseña diferente. Bajo presión, podría revelar esta contraseña a un tercero. Si se ingresa en Veles Wallet, desbloqueará un nuevo almacenamiento falso. Esto parecerá legítimo para un tercero, pero mantendrá en secreto su almacenamiento principal con monedas.',
    help2:
