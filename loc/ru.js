module.exports = {
  ...
  send: {
    ...
    details: {
      ...
      amount_placeholder: 'сколько отправить (в VLS)',
      fee_placeholder: 'плюс комиссия за перевод (в VLS)',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'Чтобы сохранить свой Bitcoin в безопасности, Veles Wallet может создать ' +
      ...
      "Veles Wallet, разблокируется 'фальшивое' хранилище. Это будет выглядеть " +
